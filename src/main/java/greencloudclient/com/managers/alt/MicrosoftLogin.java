package greencloudclient.com.managers.alt;
...
public class MicrosoftLogin {
    ...
    public static void login(Consumer<String> statusCallback) {
        ...
        try {
            if (!greencloudclient.com.utils.AndroidUtil.isAndroid() && Desktop.isDesktopSupported()) {
                Desktop.getDesktop().browse(uri);
            } else if (!greencloudclient.com.utils.AndroidUtil.isAndroid()) {
