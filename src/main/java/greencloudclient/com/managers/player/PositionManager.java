...
public class PositionManager extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        greencloudclient.com.utils.font.FontUtil.getSafeNormal().drawString("Position Editor - Drag elements to reposition", 10, 10, accent.getRGB());
        ...
        for (DraggableElement element : elements) {
            ...
            greencloudclient.com.utils.font.FontUtil.getSafeNormal().drawString(element.name, element.x, labelY, accent.getRGB());
        }
