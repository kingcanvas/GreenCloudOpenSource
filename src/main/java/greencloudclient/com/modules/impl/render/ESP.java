...
public class ESP extends Module {
    ...
    public BooleanSetting filledBox = new BooleanSetting("Filled", this, false) {
        @Override public boolean isVisible() {
            return mode.currentMode.equals("3D");
        }
    };
    ...
    public NumberSetting  cornerSize = new NumberSetting ("Corner Size", this, 0.25, 0.1, 0.5, 0.05) {
        @Override public boolean isVisible() {
            return mode.currentMode.equals("2D");
        }
    };
    ...
    private float interpolate(float prev, float curr, float pt) {
        return prev + (curr - prev) * pt;
    }
    
    private double interpolate(double prev, double curr, float pt) {
        return prev + (curr - prev) * pt;
    }
}
