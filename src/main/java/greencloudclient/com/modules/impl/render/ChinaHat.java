...
public class ChinaHat extends Module {
    ...
    public BooleanSetting useHudColor = new BooleanSetting("Use Hud Color", this, false);
    public ColorSetting hatColor = new ColorSetting("Color", this, new Color(255, 0, 0), () -> !useHudColor.enabled);
    ...
    public ChinaHat() {
        ...
        addSettings(useHudColor, hatColor, radius, height, opacity, outline);
    }
