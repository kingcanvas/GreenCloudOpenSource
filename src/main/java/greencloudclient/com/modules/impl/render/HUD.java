...
public class HUD extends Module {
    ...
    private void renderArrayList() {
        ...
        if (listMode.is("Default") && showBackground.enabled) {
            boolean useFbo = !AndroidUtil.isAndroid() && net.minecraft.client.renderer.OpenGlHelper.isFramebufferEnabled();
            boolean useBlur = !AndroidUtil.isAndroid() && blur.enabled && blurStrength.value > 0
