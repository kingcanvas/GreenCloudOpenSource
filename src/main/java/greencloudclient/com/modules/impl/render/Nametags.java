...
import greencloudclient.com.modules.impl.utility.AntiBot;
...
public class Nametags extends Module {
    ...
    private final NumberSetting  blurStr = new NumberSetting ("Blur Strength", this, 0, 0, 40, 1, () -> blur.enabled);
    ...
    public Nametags() {
        ...
        instance = this;
        addSettings(showArmor, showEnchants, showInvisible, blur, blurStr, bgAlpha, cornerRadius);
    }
    ...
    private void renderNametag(EntityPlayer player, float screenX, float screenY, float scale) {
        ...
        if (blur.enabled && blurStr.value > 0)
