...
public class FakeLag extends Module {
    ...
    private final BooleanSetting flushOnPlace = new BooleanSetting("Flush on Place", this, true);
    ...
    public FakeLag() {
        super("FakeLag", Category.UTILITY);
        addSettings(maxDelay, cooldownTime, flushOnHit, flushOnPlace, delayPing, maxPackets, showIndicator);
    }
